...
export const MULTI_EMAIL_ERROR_CODES = defineErrorCodes({
	...
	EMAIL_ALREADY_LINKED_TO_ACCOUNT: "This email is already linked to your account",
	...
	VERIFICATION_EMAIL_ALREADY_SENT: "A verification email was recently sent to this address",
